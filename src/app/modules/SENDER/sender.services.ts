...
//   // Only sender can access this
//   if (userRole !== Role.SENDER) {
//     throw new AppError(httpStatus.UNAUTHORIZED, "Unauthorized. Only sender is allowed to accept returned parcel.");
//   }
...
//   if (!parcel) {
//     throw new AppError(httpStatus.NOT_FOUND, "Parcel not found or you are not authorized to accept this parcel.");
//   }
