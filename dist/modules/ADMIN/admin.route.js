...
router.patch("/user/:id", (0, ValidateRequest_1.validateRequest)(user_validation_1.updateUserZodSchema), (0, checkAuth_1.checkAuth)(...Object.values(user_model_1.Role)), admin_controllers_1.AdminControllers.updateUser);
